...
class NuNetSWAG(GenerativeRegistrationNetwork):
    def __init__(self,
                 encoder_param,
                 i_size,
                 c_factor,
        ...
        super(NuNetSWAG, self).__init__(i_size)
    ...
    def iter_params_with_lastConvBlockInEncoder(self):
        ...
        lst_param_name = ['cdb0', 'cdb1', 'cdb2', 'cdb3', 'cb4', 'dcb5']
        # lst_param_name = ['dcb0', 'dcb4', 'dcb5', 'dcdb1', 'dcdb2', 'dcdb3']
        # lst_param_name = ['cdb0', 'cdb1', 'cdb2', 'cdb3', 'cb4',
        #                   'dcb0', 'dcb4', 'dcb5', 'dcdb1', 'dcdb2', 'dcdb3']
